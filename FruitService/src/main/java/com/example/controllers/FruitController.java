...
public class FruitController {
    ...
    @Get("/findByName")
    @NewSpan("Fruit-service")
    @Timed(value = "com.example.controllers.fruitController.findByName", percentiles = { 0.5, 0.95, 0.99 }, description = "Observing all service metric for finding a fruit object by Name")
